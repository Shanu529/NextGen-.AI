...
function Navbar() {
  ...
  const { showLogin, setShowLogin, loadCredit, logout, credit, setCredit } =
            ...
            <div className="w-5 sm:w-7 md:w-10 lg:w-10 relative group ">
              ...
              <div className="hidden absolute top-0 right-0 py-20 group-hover:block  w-20">
                <ul>
                  <li
                    onClick={logout}
                    className="bg-gray-500 text-center p-2 rounded-full text-white cursor-pointer"
                  >
                    log in
                  </li>
                </ul>
        ...
        <div className=" items-center">
          <div className="flex gap-2 sm:gap-4 md:5 text-[0.5rem] sm:text-[0.8rem] md:[text-1rem] lg:text-[1rem]">
            ...
            <button
              ...
              className="bg-black px-4 lg:px-10 lg:py-2 text-white cursor-pointer lg:rounded-full rounded-sm"
            >
              login
            </button>
          </div>
